...
#sanger_snp=mgp.v4.snps.dbSNP.vcf
#sanger_indel=mgp.v4.indels.dbSNP.vcf
...
REF=Mus_musculus.GRCm38.91.dna.toplevel.no_contigs.fa
...
###########
# ftp://ftp.ensembl.org/pub/release-75/gtf/mus_musculus/
GTF=Mus_musculus.GRCm38.75.gtf
